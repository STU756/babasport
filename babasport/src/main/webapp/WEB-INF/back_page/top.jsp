...
<link href="../res/itcast/css/theme.css" rel="stylesheet" type="text/css"/>
<link href="../res/itcast/css/jquery.validate.css" rel="stylesheet" type="text/css"/>
<link href="../res/itcast/css/jquery.treeview.css" rel="stylesheet" type="text/css"/>
<link href="../res/itcast/css/jquery.ui.css" rel="stylesheet" type="text/css"/>
                              ...
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
										...
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="product_main.do" target="mainFrame">商品</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="order_main.do" target="mainFrame">订单</a></li>
